...
no *reconstruir_arv(FILE *entrada, int *bytes_arvore);/*le o arquivo comprimido p poder reconstruir a arvore do huffman e conta quantos bytes da arvore ja foram lidos*/
